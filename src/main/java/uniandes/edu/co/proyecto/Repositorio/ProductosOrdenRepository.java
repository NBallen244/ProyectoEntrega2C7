...
public interface ProductosOrdenRepository extends JpaRepository<ProductosOrden, ProductosOrdenPK>{
    ...
    @Modifying
    @Transactional
    @Query(value = "INSERT INTO productosOrden (orden, producto, cantidad, precio_acordado) VALUES ( :orden, :producto, :capacidad, :cantidad, :precio_acordado)", nativeQuery = true)
