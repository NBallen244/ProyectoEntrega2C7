...
create table productos(
    ...
    cantidad_presentacion number(5,0) not null,
    unidad_medida varchar(50) not null,
    peso number(5,0) not null,
    volumen number(5,0) not null,
...
create table almacenajes(
    ...
    costo_promedio number(5,0)not null,
    nivel_minimo number(5,0) not null,
...
create table productosOrden (
    ...
    producto number(5,0),
    cantidad number(5,0) not null,
    precio_acordado number(5,0) not null,
